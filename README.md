...
8. Run code/rkc_code/juneau_hindcast_figure.R to create other figures for the Juneau memo. Update the write.csv and read.csv's to the relevant year
...
* Also note: the line along Lynn Sisters fishes well. That is stat area 115-14. Include the commercial catch from 115-14 as catch from Lynn Sisters, along with any comm catch inside Lynn Sisters (0 in 2026 cause it was closed).
* Another note: The Bejamin Island stat area, 115-13, is not technically part of the Juneau area but the biologists believe the Juenau population of crab is being fished there. Consider incorporating into the Juneau area catch if not already incorporated. (BUT... they don't want to manage off of the Juneau+ numbers, they want to manage off of the Juneau #'s, so perhaps discuss with Katie and the SE crab bioligists before making this change.)
