...
#####Load Data ---------------------------------------------------
personal_use1 <- read.csv(paste0(here::here(), "/data/harvest/11-A rkc pu_catch_updated2024.csv")) #AR edited to avoid df conflict
permit_type <- read.csv(paste0(here::here(), "/data/harvest/PU RKC Juneau 2022 2023 2024 permit status summary.csv")) #current year and last two, it appears - AR
permit_type_18 <- read.csv(paste0(here::here(), "/data/harvest/PU RKC Juneau permit status summary 2018 to present_updated 2024.csv"))
