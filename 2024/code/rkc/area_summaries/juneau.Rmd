---
title: "Juneau area survey results"
author: "Caitlin Stern - run and updated (the year) by Alex Reich"
date: "July 12 2024"
...
```{r CPUE, echo = FALSE }
cpue_cur_yr <- read.csv(paste0(here::here(), '/results/rkc/', survey.location, '/', cur_yr, '/JNU_CPUE_', cur_yr,'.csv'))
