...
dat <- read.csv(paste0('./data/rkc/', survey.location, '/RKC_survey_CSA_', survey.location, '_', pr_yr2, '_', cur_yr2, '.csv'))
    ...
    # update 7-26-2023 by Caitlin Stern: this data set is now generated by "pull_data_for_csa.R" script
...
#write_csv(temp, paste0('./data/rkc/', survey.location, '/LS_missing_recruit_status' , cur_yr, '.csv'))
...
# look at results to see the spread among strata...in high biomass years even low strata 1,2 had higher CPUE. >1 or 2
...
glimpse(dat1) # raw data for both previous year and current year
    # slope = 3.07
    # intercept = 7.42
