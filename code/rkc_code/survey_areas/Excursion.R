...
panel_figure('Excursion', 2019, 'Excursion', 1) # panel with all 3 figures
panel_figure('Excursion', 2019, 'Excursion', 2) # male panel
panel_figure('Excursion', 2019, 'Excursion', 3) # female panel
