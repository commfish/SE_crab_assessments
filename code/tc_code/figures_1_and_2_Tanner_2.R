...
harvest <- read.csv(paste0('./data/harvest/tanner_harvest_', cur_yr,'.csv')) # harvest harvest since 2017; add current year's harvest to this file or 
# repull all years- pulled from one of the pull file steps AGR
