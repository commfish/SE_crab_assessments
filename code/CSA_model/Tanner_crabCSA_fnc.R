# K.Palof 12-5-16
# Tanner crab function for CSA model - use alternative fnc for bootstrap to speed it up.  
...
crabCSA <- function (area = NULL, M = NULL, initial = c(NA, NA, NA, NA, NA), uprn = NA, graph = TRUE)
{  
  year = area$Year
