...
2
# Male weight-at-length (note that this is by stage for Juneau area RKC)
...
## Gear-1    Gear-2   
   ...
   0         0        # sex specific selectivity, 0 male only fishery
   0         3        # male selectivity type (0=flat, or logistic or double normal)
   0         0        # within another gear insertion of fleet in another
   0         0        # extra parameters
## Gear-1    Gear-2   
   1         1        # Retention time periods
   0         0        # sex specific retention, 0 for male only fishery
   3         6        # male retention type (flat equal to one, 1 parameter)
...
## ———————————————————————————————————————————————————————————————————————————————————— ##
# Gear-1  Pot fishery, both commercial and personal use (combined)
   1     1     1   0    0.4    0.001 1.0    0       0      1    3      1979   2022 0    0   0        1979    1979      0.0
   1     2     2   0    0.7    0.001 1.0    0       0      1    3      1979   2022 0    0   0        1979    1979      0.0
   1     3     3   0    1.0    0.001 2.0    0       0      1    -2     1979   2022 0    0   0        1979    1979      0.0 
# Gear-2  ADF&G pot survey
   2     4     1   0    40      10.0  200    0      10    200   -3     1979   2023  0    0   0        1979    1979      0.0 # update end yr
   2     5     2   0    60      10.0  200    0      10    200   -3     1979   2023  0    0   0        1979    1979      0.0 # update end yr
...
## ==================================================================================== ##
## M Type. !fix do we want constant M?
0
...
## =========================================================================================== ##
 ...
 0.000000      -2          2        -99      0                        # Dummy to return to base value
