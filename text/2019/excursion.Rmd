...
```{r CPUE, echo = FALSE }
cpue_cur_yr <- read.csv(paste0(here::here(),'/results/rkc/Excursion/', cur_yr, '/EI_CPUE_', cur_yr,'.csv'))
...
male_weights <- read.csv(paste0(here::here(),'/results/rkc/Excursion/', cur_yr,'/maleweights.csv'))
kable(male_weights, digits = 3)
```

## Short term trends in CPUE
```{r short term, echo = FALSE }
short_term_results <- read.csv(paste0(here::here(),'/results/rkc/Excursion/', cur_yr,'/shortterm.csv'))
...
long_term_results <- read.csv(paste0(here::here(),'/results/rkc/Excursion/', cur_yr,'/longterm.csv'))
...
poorclutch_curyr <- read.csv(paste0(here::here(),'/results/rkc/Excursion/', cur_yr,'/poorclutch_summary_all.csv'))
poorclutch_curyr %>% 
...
lt_female <- read.csv(paste0(here::here(),'/results/rkc/Excursion/', cur_yr,'/lt_female.csv'))
...
short_female <- read.csv(paste0(here::here(),'/results/rkc/Excursion/', cur_yr,'/short_female.csv'))
...
egg_per_mean <- read.csv(paste0(here::here(),'/results/rkc/Excursion/', cur_yr,'/egg_percent_mean_all.csv'))
egg_per_mean %>% 
...
stock_health <- read.csv(paste0(here::here(),'/results/rkc/Excursion/', cur_yr,'/stock_health.csv'))
