---
title: "Southeast red king crab assessment 2022 CONFIDENTIAL RIR draft "
...
FYI: *italics* information is not completed yet, this is a draft of the RIR for both research(biometrics) and management. Management sections are also labeled TBD in this draft.


# `r cur_yr` QUICK SUMMARY {-}
  - Regional legal biomass decreased again in `r cur_yr` and has been declining since 2017, regional mature biomass increased slightly primarily due to the influence of the Juneau area
  - Juneau area is at healthy stock health, Lynn Sisters and Gambier Bay are at moderate stock health, Pybus Bay, Seymour Canal, and Peril Strait are below average health, and Excursion Inlet is poor. Stock health considers all aspects of the population (mature males, juveniles, and females).
  - Juneau, Gambier Bay and Peril Strait are the only areas with an increase in both legal and mature biomass from `r pr_yr`. Gambier Bay and Peril Strait are small contributors to the regional biomass compared to the Juneau area. 
  - None of the harvest rate options (low risk HR or max appropriate HR) reach a harvestable surplus above the 200,000 lb threshold (Table 2, 3).
...
*The `r cur_yr`/`r fut_yr` Southeast commercial RKC fishery GHL is XXXXX lb and is less than the 200,000 lb minimum threshold [5 AAC 34.113]; therefore, the fishery did not open for the `r cur_yr`/`r fut_yr` season.* 

The personal use RKC and BKC fishery opened July 1, 2022 in non-surveyed areas with bag and possession limits of one RKC or BKC per person. Results from the annual stock assessment survey in the Juneau Area (Section 11-A) showed overall stock health to be at healthy stock levels, with both legal and mature biomass estimated to be above the long-term average. *The personal use summer fishery in Section 11-A opened on August 19, 2022 for three and a half days with a seasonal household limit of two crab and daily bag and possession limit of two crab (Table 2) to target XXXXX lb (XXXX crab) in the summer fishery.*
...
The Southeast RKC stock assessment regional biomass estimates for the `r cur_yr`/`r fut_yr` season are **`r round(b_cur_yr$TOTAL_leg/1000000, 2)` million lb of legal crab and `r round(b_cur_yr$TOTAL_mat/1000000, 2)` million lb of mature crab**, using the historical expansion factor (Tables 2–3). The legal biomass estimate decreased 4.6% from the previous year using the `r cur_yr` model estimates (Figure \@ref(fig:regionalbio)). The mature biomass estimate increased 4.7% from `r pr_yr` using the `r cur_yr` model estimates. 

Survey area biomass is estimated using a 3-stage catch survey analysis model (CSA) and adjusted using the mark-recapture expansions where available (Stratman et al. 2019). Port Frederick and Holkham Bay have not been surveyed since 2015 due to reductions in survey funding and therefore are no longer included in determining survey biomass estimates. The legal crab component is composed of both recruit and postrecruit crab and defined as those greater than 178 mm in carapace width, whereas mature crab are prerecruit, recruit, and postrecruit crab, or those greater than 129 mm in carapace length. Biomass estimates from the survey areas (Table 2, Figure \@ref(fig:distcur)) are then expanded based on assumptions of how representative these areas are to the entire population in Southeast.  

Both mature and legal survey biomass declined an average of 7.0% annually from 2001–2013 (Figure \@ref(fig:regionalbio)). Legal and mature biomass showed region-wide increases for the first time in 2015 since 2008 and continued to increase until 2017. In 2017 the commercial fishery was opened and the regionwide stock has decreased slowly since then. This year is the first since 2017 that both legal and mature regional biomass did not decrease, although only four of the seven survey areas (Lynn Sisters, Juneau, Gambier Bay, and Peril Strait) had increases in either legal or mature biomass (Figures \@ref(fig:pybus2) – \@ref(fig:excursion3)). 
From 2017 to 2022, in the absence of a commercial fishery, legal biomass has declined an average of 2% annually and mature biomass has declined an average of 3% annually.

The CPUE of juvenile and female sizes classes has improved in four of the seven survey areas (Pybus Bay, Gambier Bay, Juneau, and Lynn Sisters) to be above the average levels, suggesting some improvement in these components. 
...
Pybus Bay, Seymour Canal, and Excursion Inlet had significantly low values in all mature male CPUEs, Gambier Bay and Peril Strait had two of three mature male recruit classes below their long-term averages, and Juneau had one of three mature male recruit classes below the long-term average. 

Recruitment, in the form of prerecruit CPUE, is significantly below average levels for five of the seven surveys areas. Only Lynn Sisters and Juneau are at or significantly above the long-term average for prerecruit CPUE, suggesting that regionwide improvements to mature and legal male biomass are still underway and may take a few more years even with the absence of fishing in most of the survey areas. 
Even with some improvements prerecruit biomass is still lacking compared to the 1990s and early 2000s, which is visualized as the small difference between mature and legal biomass in the area figures (Figures \@ref(fig:pybus2) – \@ref(fig:excursion3)). 

A matrix of stock health indicators provides an objective and repeatable evaluation of the survey data; a five-year summary of matrix results is therefore presented here (Table 4).  Specific stock health by survey area (Table 5) is discussed below.  

## MARK-RECAPTURE EXPERIMENT ADJUSTMENTS {-}
All survey areas (Excursion Inlet, Lynn Sisters, Peril Strait, Pybus Bay, Gambier Bay, and Seymour Canal; Figure \@ref(fig:distcur)), except Juneau, due to its expansive area, have a biomass adjustment that is calculated from mark-recapture studies (Table 1). Two of the six survey areas have a single mark-recapture event, while the other four have two events; therefore, the estimate of biomass using this method does not take into account extensive inter-annual variability or variability in population size for all areas and should be applied with caution. 
...
The resulting GHL for option 2 is **`r format((table3 %>% filter(Location == 'total'))$Comm.GHL, big.mark = ",")` lb** (Table 3). 
...
Regional legal biomass levels have decreased from `r pr_yr` while mature biomass levels have increased slightly, although both are still below the baseline levels (Figure \@ref(fig:regionalbio)). The Juneau Area and Lynn Sisters area the only survey areas where legal or mature biomass are above their baseline levels. 

Slow recovery since 2001, which may be due to poor or inconsistent recruitment, and declines in the survey areas after the last commercial fishery opening (2017/2018 fishing season), suggest that harvesting at the equilibrium harvest levels (those used in the 2017/2018 GHL calculations, option 1 here) from these areas would increase the probability of continued population declines or stunt population growth. Thus, removals at the levels presented in options 1 and 2 (Tables 2 and 3) are not recommended for the upcoming season. None of the harvest options presented here resulted in a GHL that is above the 200,000 lb threshold required for a fishery opening [5 AAC 34.113]. 
...
Significance in long-term or short-term trends is defined as a p-value <0.05. Long-term trends compare the current year’s mean to the long-term baseline value (1993–2007); short-term trends regress the last four years of survey data to determine if a significant increasing or decreasing trend is present. Estimates of legal and mature mark-recapture biomass (adj.legal / adj.mature) for the entire biomass time series for each area were added to the legal biomass graphs, along with their associated long-term baseline (1993–2007; solid black line for legal and grey dotted line for mature) estimates (Figures \@ref(fig:pybus2) – \@ref(fig:excursion3)). Raw sample sizes for each area are reported in Table 6. Graphs for each area reflect biomass estimates from the `r cur_yr` CSA model.

## Pybus Bay (below average) {-}
Pybus Bay stock health increased but remained in below average status (Figures \@ref(fig:pybus2), \@ref(fig:pybus3)). Juvenile male and female CPUEs increased to be above their long-term average but not significantly so. Mature female, postrecruit, recruit, and prerecruit male CPUEs are significantly below their long-term averages. 
There are significant short-term increasing trends in juvenile male and female CPUEs, which suggest some improvement for this area may be upcoming. 
Legal biomass decreased 33% from the `r pr_yr` model and mature biomass decreased 24%. 
Both decreased and remain low compared to historical levels in this area. Female egg percentage is at a normal level and the percentage of poor clutches is significantly below the baseline value. 
...
## Gambier Bay (moderate) {-}
Gambier Bay stock health increased from below average to moderate status (Figures \@ref(fig:gambier2), \@ref(fig:gambier3)). Prerecruit, recruit, and mature female CPUEs are significantly below their long-term averages. Juvenile males and juvenile females are significantly above their long-term averages, and postrecruits are below average but not significantly so. In the short-term (last four years), there is a significant increase in juvenile male and female CPUEs. 

Juvenile and female portions of this population are historically high for this area, suggesting potential improvement for this stock in the upcoming years, although it can take multiple years for juveniles to molt into the mature male population.
The proportion of females with poor clutches is significantly below the long-term baseline of 10% and the overall average clutch fullness was back to typical levels. 
Legal biomass increased 20% and mature biomass increased 30% from the `r pr_yr` model estimate, however biomass estimates are still low compared to historical levels for this area. 
The mature biomass estimate is `r round((baseline_rel %>% filter(Location == 'Gambier'))$pct.adj.cur, 0)`% below the baseline value. 

Stock health is improving but has been low in Gambier Bay the last few years and is categorized as moderate. Half of the sex/size classes remain significantly below their long-term averages, while juvenile portions of the population suggest improvements. Considering these negative trends in Gambier Bay, no harvestable surplus is recommended for the `r cur_yr`/`r fut_yr` season. 

## Seymour Canal (below average) {-}
The overall stock health for Seymour Canal increased from poor to below average due primarily to the increase in juvenile males (Figures \@ref(fig:seymour2), \@ref(fig:seymour3)). All of the sex/size classes, with the exception of juvenile males, are significantly below their long-term averages, and there were low numbers of recruit and postrecruit male crab sampled in the survey pots in `r cur_yr`. 
There are no significant short-term trends. 
In general, portions of this populations have been under sampled in the last few years of the survey, this year specifically no juvenile females were caught and recruit/postrecruit numbers were low (Table 6), and therefore caution should be taken in interpreting any of the indicators of stock health. Based on the survey results for the past few years it may be appropriate to reexamine the survey footprint and methods for this area.
The estimate of legal biomass decreased 33% and the mature biomass decreased 17% from the `r pr_yr` model estimates. 
The mature biomass estimate is `r round((baseline_rel %>% filter(Location == 'Seymour'))$pct.adj.cur, 0)`% below the baseline value.   

Stock health in Seymour Canal has increased to below average. Mature male CPUEs were under sampled again in this years survey. No short-term increases are evident. Due to the aforementioned concerns and the low level of the stock biomass in Seymour Canal, no harvestable surplus is recommended for the `r cur_yr`/`r fut_yr` season. 

## Peril Strait (below average) {-}
The Peril Strait stock status remained at below average status but shows signs of improvement (Figures \@ref(fig:peril2), \@ref(fig:peril3)). 
Most sex/size classes, except recruit males, are significantly below their long-term averages. 
There is a significant short-term increasing trend in all CPUEs, except postrecruit males, suggesting signs of improvements for this population may be upcoming.  
This is the second consecutive year of increases for female and juvenile portions of the population. 
...
The legal biomass estimate increased 161% and the mature biomass increased 14% from the `r pr_yr` model estimates, due to increases in prerecruit and recruit CPUEs.  
The CPUEs for prerecruit and recruit males is larger than has been recorded since 2008, making this the second year of increases in the mature male population indicating potential signs of some recovery in this area. 
The mature biomass estimate is `r round((baseline_rel %>% filter(Location == 'Peril'))$pct.adj.cur, 0)`% below the baseline value. 

Stock health in Peril Strait remains a concern. Nearly all size/sex classes are significantly below their long-term averages, but short-term increasing trends in many portions of the population provide some hope for future improvement. Legal and mature biomass estimates remain below long-term averages; therefore, no harvestable surplus is recommended for the `r cur_yr`/`r fut_yr` season. 

## Juneau (healthy) {-}
The stock status for the Juneau area increased to healthy from above average last year (Figures \@ref(fig:juneau2), \@ref(fig:juneau3)). 
Only recruit CPUE is significantly below the long-term average, while juveniles (both male and female), prerecruits, and postrecruits were significantly above the long-term averages. Mature female CPUE is at the long-term average. There are significant short-term increasing trends in juvenile male, juvenile female, prerecruit, and recruit CPUE. 
When compared to the `r pr_yr` model estimate, legal biomass increased 1.5%, while mature biomass increased 21%. 
Indicators of female stock health remain good as indicated by the low proportion of poor clutches and high clutch fullness. Legal biomass is still at its long-term baseline value while mature biomass increased to be `r round((baseline_rel %>% filter(Location == 'Juneau'))$pct.adj.cur, 0)`% above the baseline. 

The annual 11-A red king crab stock assessment survey found both the legal and mature biomass had increases compared to last year. Prerecruit and juvenile CPUEs increased from the `r pr_yr` survey. Due to stable trends in the mature size/sex classes, the decision was made in July to set the harvest rate at 7.0% for the `r cur_yr`/`r fut_yr` season.

## Lynn Sisters (moderate) {-}
Stock health in the Lynn Sister’s area remained at a moderate status in `r cur_yr` (Figures \@ref(fig:lynn2), \@ref(fig:lynn3)). CPUEs for all size and sex classes are near their long-term averages, although mature male CPUEs decreased from the high values of the last few years. 
...
Legal biomass increased 3%, while mature biomass decreased 8% from the `r pr_yr` model estimates, but the `r cur_yr` model output has both with increasing trends. 
...
Positive trends in stock health are evident. Legal and mature biomass estimates are above long-term baselines for the fourth time in nine years. The majority of size/sex classes are at or above long-term averages. 
Positive trends in stock health have become evident after a nine-year closure to all fishing, but the adjusted legal biomass estimate is smaller than seen in all other survey areas with the exception of Peril Strait (Table 2). 
...
### Table 2. Option 1: Maximum appropriate / risk neutral – model-based equilibrium harvest rates {-}
...
df %>% 
  ...
  mutate(Location = ifelse(Location == "Pybus", "Pybus Bay", 
                           ifelse(Location == "Gambier", "Gambier Bay", 
                                  ifelse(Location == "Seymour", "Seymour Canal", 
                                         ifelse(Location == "Peril", "Peril Strait", 
                                                ifelse(Location == "LynnSisters", "Lynn Sisters", 
                                                 Location)))))) -> df
...
\newpage
### Table 3. Option 2: risk adverse – high probability of mature male biomass increasing  {-}
                           ...
                           ifelse(Location == "Gambier", "Gambier Bay", 
                                  ifelse(Location == "Seymour", "Seymour Canal", 
                                         ifelse(Location == "Peril", "Peril Strait", 
                                                ifelse(Location == "LynnSisters", "Lynn Sisters", 
                                                 Location))))))-> df
names(df) <- c("Survey area", "Legal biomass (adj)", "Mature biomass (adj)", "Avg Inc HR", 
               "Total GHL", "PU catch", paste0(cur_yr, " Commercial GHL(lb)"))
#knitr::kable((df), booktabs = T, caption = "Table 2")
ft <- flextable(df)
#ft <- autofit(ft)
...
\newpage
### Table 6. Sample sizes for the `r cur_yr` survey by area {-}

```{r table6, results = "asis"}
df <- read.csv(paste0(here::here(),'/results/rkc/Region1/', cur_yr, '/Table7_raw_samp_', cur_yr,'.csv'))
df %>% 
  select(-Year) -> df
names(df) <- c(" ", "Peril Strait", "Excursion Inlet", "Gambier Bay", "Juneau", "Lynn Sisters",
...
\newpage
### **NOT COMPLETE** Table 7. Summary of `r cur_yr` commercial red king crab fishery GHL calculations (in pounds) and harvest rate recommendations for the 7 surveyed areas and non-surveyed areas. Mature biomass is adjusted with the mark recapture experiment. Biomass of non-surveyed areas was expanded to be 47.2% of the region. {-}
...
df %>% 
  mutate(Mature.HR = c(0, 0, 0, 0, 0.07, 0.09, 0, 0, 0.10, 0)) %>% # from stock health & previous years results
  mutate(Total.GHL = round(adj.mature*Mature.HR,0), 
         ...
         bkc_temp = round(sum(Comm.GHL.adj[Location%in%survey.locations], na.rm = TRUE)*0.0106, 0), 
         Comm.GHL.adj = ifelse(Location == "bkc", bkc_temp, Comm.GHL.adj)) %>% 
  select(-bkc_temp) -> df2
df2 %>% 
  mutate(Comm.GHL.adj = ifelse(Location == "total", (sum(df2$Comm.GHL.adj)), Comm.GHL.adj)) %>% 
  select(Location, adj.legal, adj.mature, Mature.HR, Total.GHL, PU.catch, Comm.GHL.adj) ->df3

names(df3) <- c("Survey area", "Legal biomass (adj)", "Mature biomass (adj)", "Mature HR", 
               "Total GHL", "PU catch", paste0(cur_yr, " Commercial GHL(lb)"))
...
### ~a~ The Juneau area was open to personal use harvest in summer `r cur_yr` at a harvest rate of 7%. “n/a” represents data that is not available or readily estimable from the other bays.{-}
...
```{r regionalbio, fig.cap = "Total biomass estimates (expanded regional estimates) of mature (gray points and line) and legal (black points and line) red king crab in Southeast Alaska. Estimates based on Catch-Survey Analysis (CSA) methodologies adjusted using mark-recapture study results (Table 1) then further expanded to include non-survey areas. Reference lines represent long-term (1993–2007) average of legal and mature biomass estimates.  Triangles represent years without commercial harvest."}
knitr::include_graphics(paste0(here::here(),'/figures/rkc/', cur_yr, '/Expanded_MRregional_biomass2_', cur_yr,'.png'), dpi = 125)
```
...
```{r lynn2, fig.cap = "Lynn Sisters CPUEs for male size/sex classes of red king crab, biomass estimates from the current year’s CSA model and harvest data. Reference lines represent long-term baselines for each parameter (1993–2007). Gray dotted reference line in the biomass figure represents the long-term baseline for mature biomass, while the solid black refers to the legal biomass. There are no significant trends in mature male CPUEs."}
...
df <- read.csv(paste0(here::here(),'/results/rkc/Region1/', cur_yr, '/biomass_', cur_yr,'.csv'))
df %>% 
