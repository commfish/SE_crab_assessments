...
The resulting GHL for option 1 is XXXXXX lb (Table 2). 
...
The resulting GHL for option 2 is XXXXX lb (Table 3). 
...
In general portions of this populations have been undersampled in the last few years of the survey, this year specifically no juvenile females, prerecruit or recruits were caught (Table 5), and therefore caution should be taken in interpreting any of the indicators of stock health. Based on the survey results for the past few years it may be appropriate to rexamine the survey footprint and methods for this area.
...
## Figures and Tables {-}
Table A1: regional_biomass_2021.csv
