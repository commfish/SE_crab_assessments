---
title: "Gambier Bay area survey results"
author: "Alex Reich and Caitlin Stern"
date: "July 24, 2024"
...
```{r CPUE, echo = FALSE }
cpue_cur_yr <- read.csv(paste0(here::here(),'/results/rkc/', survey.location, '/', cur_yr, '/GB_CPUE_', cur_yr,'.csv'))
...
kable(poorclutch_curyr, digits = 3) #something is up, this is not right, means and sd's are the same
```
